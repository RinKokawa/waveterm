...
const FlagColors: { label: string; value: string }[] = [
    { label: t("tab.color.green"), value: "#58C142" },
    { label: t("tab.color.teal"), value: "#00FFDB" },
    { label: t("tab.color.blue"), value: "#429DFF" },
    { label: t("tab.color.purple"), value: "#BF55EC" },
    { label: t("tab.color.red"), value: "#FF453A" },
    { label: t("tab.color.orange"), value: "#FF9500" },
    { label: t("tab.color.yellow"), value: "#FFE900" },
];
...
export function buildTabContextMenu(
    ...
    menu.push(
        { label: t("tab.menu.rename"), click: () => renameRef.current?.() },
        {
            label: t("tab.menu.copyTabId"),
    ...
    menu.push({ label: t("tab.menu.flagTab"), type: "submenu", submenu: flagSubmenu }, { type: "separator" });
    ...
    if (bgKeys.length > 0) {
        ...
        menu.push({ label: t("tab.menu.backgrounds"), type: "submenu", submenu }, { type: "separator" });
    }
    menu.push(...buildTabBarContextMenu(env), { type: "separator" });
    menu.push({ label: t("tab.menu.closeTab"), click: () => onClose(null) });
    return menu;
}
