...
// FORK: data-monitor widget — see frontend/app/view/datamonitor/datamonitor.tsx
import { DataMonitorViewModel } from "@/app/view/datamonitor/datamonitor";
...
BlockRegistry.set("datamonitor", DataMonitorViewModel);
