---
name: context-menu
description: Guide for creating and displaying right-click context menus in Wave Terminal. Use when implementing context menus, adding context menu items, creating submenus, or handling menu interactions with checkboxes and separators.
---
    ...
    submenu: [
      {
        ...
        click: () => {
          // Set the config to enable clear on start
        },
      },
      {
        label: "Off",
        ...
        checked: !isClearOnStart,
        click: () => {
          // Set the config to disable clear on start
        },
      },
    ],
  },
