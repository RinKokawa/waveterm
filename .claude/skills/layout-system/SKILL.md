---
name: layout-system
description: Architecture reference for Wave Terminal's tile-based layout system. Use when working on drag-and-drop layouts, resize operations, layout actions, tree manipulation, or layout state management.
---
...
`layoutNode.ts` provides core node manipulation:
