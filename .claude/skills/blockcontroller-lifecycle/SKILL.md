---
name: blockcontroller-lifecycle
description: Guide for understanding Wave Terminal's block controller lifecycle. Use when working on terminal/process controllers, restarting shells, handling controller status events, or implementing controller-driven views.
---
...
**Event Subscription:**
The constructor subscribes to controller status events:
...
**Important:** Registering a new controller automatically stops any existing controller for that blockId:
...
The `registerController()` function handles this automatically.
