---
name: waveai-architecture
description: Architecture reference for the Wave AI chat feature in Wave Terminal. Use when working on AI providers (OpenAI, Anthropic, Perplexity, Google, Wave Cloud), chat streaming, or the waveai block view.
---
