...
description: Guide for creating ViewModels and ViewComponents in Wave Terminal. Use when implementing new block types, designing UI with Jotai atoms, or building model-view components following the Wave Terminal architecture.
---
